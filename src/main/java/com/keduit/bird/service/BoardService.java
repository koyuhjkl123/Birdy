...
import com.keduit.bird.dto.BoardImgDTO;
...
public class BoardService {
    ...
    public Long saveBoard(BoardDTO boardDTO, List<MultipartFile> boardImgFileList) throws Exception {
        ...
        for (int i = 0; i < boardImgFileList.size(); i++) {
            ...
            BoardImg.setBoard(boardDTO);
            boardFileRepository.saveCommunityImg(BoardImg, boardImgFileList.get(i));
        }
