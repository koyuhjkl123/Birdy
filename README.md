...
* 담당 역할
  ...
  * 마이페이지
    ...
    * 프로필 사진 업로드 기능
    * 정보 변경 시 업데이트 기능
    * 회원이 작성한 글(게시글, 댓글) 조회 기능
  * About US
    * 사이트 소개 및 팀원 소개
  * 새의 앨범
    * **"ㄱ, ㄴ, ㄷ"** 모음에 따른 데이터 분류
    * 멸종 위기종 **1급, 2급** 별 분류
    * 새의 사진과 이름, 간략한 설명으로 구성
...
## 이세진(팀원)
웹 페이지에서 필요한 데이터를 크롤링해오고, 이메일을 통한 인증방식 구현과 소셜 로그인을 구현하는 데에 많은 시행착오를 거치며
힘들기도 했지만, 새로운 것을 도전하고, 시도하고, 그 것이 성공했을 때의 성취감을 느낄 수 있어 즐거웠습니다.<br>
웹 사이트 하나를 구현하는 데에 얼마나 많은 시간과 고뇌가 필요한지 확실히 깨달을 수 있는 경험이었고, 너무나 당연하게 사용하던 기능들이
사실은 이렇게 복잡하고 어려운 과정들을 통한 결과물이었다는 것에 새삼 개발자에 대한 놀라움과 대단함을 느낄 수 있었습니다.<br>
좀 더 원활하고, 좀 더 완벽한 기능을 구현하고 싶었지만, 아직 기술과 경험부족으로 머릿속에 상상하던 것이 완전히
구현되지 못 한 것에 대한 아쉬움이 남습니다.<br>
이후에는 이번에 제가 구현해내지 못 한 기능들도 구현해보면서 미처 시도하지 못 한 기능들에도 모두 도전 해 보고 싶습니다.<br>
## 김기윤(팀원)
